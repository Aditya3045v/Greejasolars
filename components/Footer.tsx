            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-2 mb-6 text-white text-2xl font-bold">
                            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center overflow-hidden p-1 shadow-glow-blue">
                                <img src="/assets/logo.png" alt="Greeja Organic Solar Energy" className="w-full h-full object-contain" />
                            </div>
                            <span className="uppercase">GREEJA <span className="text-primary">ORGANIC</span></span>
                        </div>
                        <p className="max-w-sm text-sm leading-relaxed mb-6 text-slate-400">
                            Greeja Organic Solar Energy Private Limited provides reliable and affordable solar power solutions, delivering high-quality installations with a strong focus on service excellence.
                        </p>

                        <div className="space-y-3 mb-6">
                            <div className="flex items-center gap-3 text-sm">
                                <Phone size={16} className="text-primary" />
                                <span>079034 06429</span>
                            </div>
                            <div className="flex items-center gap-3 text-sm">
                                <Mail size={16} className="text-primary" />
                                <span>info@greejaorganic.in</span>
                            </div>
                            <div className="flex items-start gap-3 text-sm text-slate-400">
                                <MapPin size={16} className="text-primary mt-1 flex-shrink-0" />
                                <span>Majhaulia Rd, Krishna Chowk, Pokhraira, Muzaffarpur, Bihar – 842001</span>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/#calculator" className="hover:text-primary transition-colors">Residential Solar</Link></li>
                            <li><Link href="/#calculator" className="hover:text-primary transition-colors">Commercial Solar</Link></li>
                            <li><Link href="/#calculator" className="hover:text-primary transition-colors">Industrial Solar</Link></li>
                            <li><Link href="/#calculator" className="hover:text-primary transition-colors">Off-Grid Systems</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a href="/contact" className="hover:text-primary transition-colors">High-Quality Setup</a>
                            </li>
                            <li>
                                <a href="/contact" className="hover:text-primary transition-colors">Technical Survey</a>
                            </li>
                            <li>
                                <a href="/contact" className="hover:text-primary transition-colors">Installation Support</a>
                            </li>
                            <li>
                                <a href="/contact" className="hover:text-primary transition-colors">Maintenance</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs">
                    <p>© Greeja Organic Solar Energy Private Limited 2026. All rights reserved.</p>
