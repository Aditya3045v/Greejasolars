                        ...
                        <div className="bg-[#0f172a] rounded-[2rem] p-8 shadow-xl text-white flex flex-col justify-between h-full border border-white/10 relative overflow-hidden group hover:-translate-y-1 transition-transform">
                            ...
                            <div className="mt-auto">
                                <p className="text-slate-400 text-sm mb-4">
                                    Our expert will visit your property in the Muzaffarpur area to assess roof feasibility and solar requirements.
                                </p>
                                <a href="tel:07903406429" className="text-white font-bold border-b border-primary hover:text-primary transition-colors pb-0.5 inline-flex items-center gap-1">
